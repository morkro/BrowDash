...
function(a) {
    ...
    1: [ function(a) {
        ...
        var c = a("./utils/elements"), d = a("./utils/constants"), e = a("./utils/helper"), f = a("./views/dialog.settings"), g = b(f), h = a("./modules/browtimer"), i = b(h), j = a("./modules/browdialog"), k = b(j), l = a("./modules/browcard"), m = b(l), n = a("./modules/browlayoutmanager"), o = b(n), p = null, q = null, r = function() {
        ...
        "./modules/browcard": 2,
        "./modules/browdialog": 3,
        "./modules/browlayoutmanager": 4,
        "./modules/browtimer": 5,
        "./utils/constants": 6,
        "./utils/elements": 7,
        "./utils/helper": 8,
        "./views/dialog.settings": 9
    } ],
    2: [ function(a, b, c) {
        /**
 * @name				BrowCard
    ...
    4: [ function(a, b, c) {
        ...
        var e = a("../utils/helper"), f = function() {
            function a(b, c) {
                ...
                console.log(this), this.addEvents(), this.addDraggabilly();
            }
            /**
