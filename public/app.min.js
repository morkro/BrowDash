  ...
  */
            return a.prototype.createCard = function() {
                switch (this.config.type) {
                  ...
                  default:
                    return console.warn("I couldn't find \"" + this.config.type + '" module :( Take this <text-card> instead :)'), 
                    document.createElement("text-card");
                }
 ...
 */
        ...
        var d = function(a) {
            ...
            a.preventDefault();
            var b = a.target, c = "A" === b.nodeName, e = d(this.categoryList).parentNode;
            c && !b.parentNode.classList.contains("is-active") && (e.classList.remove("is-active"), 
