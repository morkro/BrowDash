...
function(a) {
    ...
    1: [ function(a) {
        ...
        var c = a("./utils/elements"), d = a("./utils/constants"), e = a("./utils/helper"), f = a("./views/dialog.settings"), g = b(f), h = a("./modules/timer"), i = b(h), j = a("./modules/dialog"), k = b(j), l = a("./modules/card"), m = b(l), n = a("./modules/layoutmanager"), o = b(n), p = null, q = null, r = function() {
            p = new i["default"](c.timer);
            var a = {
                dateFormat: null,
                abbreviations: !1
            };
            ...
            })) : (a.dateFormat = "24h", p.setDateFormat({
                format: a.dateFormat
            }), localStorage.setItem(d.BROW_SETTINGS, JSON.stringify(a))), p.run();
        }, s = function() {
            ...
            q = new o["default"](c.content, c.contentOverlay), q.layout();
        }, v = function() {
            ...
            } else for (var b = 0; b < localStorage.length; b++) t(b);
        }, w = function(a) {
            a.preventDefault();
            var b = this.getAttribute("data-create-card"), d = new m["default"]({
                type: "" + b
            });
            c.content.appendChild(d), q.add(d);
        }, x = function() {
            [].forEach.call(c.newCard, function(a) {
                a.addEventListener("click", w);
            });
        };
        /* Initialise app */
        window.isEditMode = !1, v(), r(), u(), s(), e.setTheme(), x();
    }, {
        "./modules/card": 2,
        "./modules/dialog": 3,
 ...
 */
  ...
  */
    ...
    5: [ function(a, b, c) {
        ...
        c.__esModule = !0;
        var e = a("../utils/elements"), f = function() {
            function a() {
                d(this, a), this.duration = 2e3, this.elem = e.snackbar, this.message = "Ooops, something went wrong! :(";
            }
            return a.prototype.alert = function() {
                var a = void 0 === arguments[0] ? this.message : arguments[0];
                this.message = a.trim(), this.show();
            }, a.prototype.show = function() {
                var a = this;
                this.elem.innerText = this.createParagraph(), this.elem.classList.add("is-visible"), 
                setTimeout(function() {
                    a.elem.classList.remove("is-visible"), a.elem.innerText = null;
                }, this.duration);
