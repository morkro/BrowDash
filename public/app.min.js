...
function(a) {
    ...
    1: [ function(a) {
        ...
        var c = a("./utils/elements"), d = a("./utils/constants"), e = a("./utils/helper"), f = a("./views/dialog.settings"), g = b(f), h = a("./modules/timer"), i = b(h), j = a("./modules/dialog"), k = b(j), l = a("./modules/card"), m = b(l), n = a("./modules/layoutmanager"), o = b(n), p = a("./modules/snackbar"), q = b(p), r = null, s = null, t = 0, u = function() {
            var a = new q["default"]();
            t && a.alert(navigator.onLine ? "Your internet connection is stable again, awesome!" : "Your internet connection suddenly went offline. BrowDash will still work like before, but some cards might not update."), 
            t++;
        }, v = function() {
            r = new i["default"](c.timer);
            var a = {
                dateFormat: null,
                abbreviations: !1
            };
            ...
            })) : (a.dateFormat = "24h", r.setDateFormat({
                format: a.dateFormat
            }), localStorage.setItem(d.BROW_SETTINGS, JSON.stringify(a))), r.run();
        }, w = function() {
            var a = window.location.href.slice(0, -1);
            [].forEach.call(c.openDialog, function(b) {
                var d = b.getAttribute("data-dialog"), e = !1;
                "settings" === d && (e = g["default"]);
                var f = new k["default"]({
                    elem: b,
                    dialogElem: c.dialog,
            ...
            s = new o["default"](c.content, c.contentOverlay), s.layout();
        }, z = function() {
            ...
            } else for (var b = 0; b < localStorage.length; b++) x(b);
        }, A = function(a) {
            a.preventDefault();
            var b = this.getAttribute("data-create-card"), d = new m["default"]({
                type: "" + b
            });
            c.content.appendChild(d), s.add(d);
        }, B = function() {
            window.addEventListener("online", u), window.addEventListener("offline", u), [].forEach.call(c.newCard, function(a) {
                a.addEventListener("click", A);
            });
        };
        /* Initialise app */
        window.isEditMode = !1, z(), v(), y(), w(), u(), e.setTheme(), B();
    }, {
        "./modules/card": 2,
        "./modules/dialog": 3,
 ...
 */
  ...
  */
            return a.prototype.init = function() {
                ...
                b ? this.closeDialog(a) : this.loadContent(a);
    ...
    5: [ function(a, b, c) {
        ...
        var e = function() {
            ...
            return a.prototype.alert = function() {
                ...
                this.message = a.trim(), this.show(), console.log("this");
  ...
  */
    ...
    10: [ function(a, b, c) {
        ...
        var d = a("../utils/constants"), e = a("../utils/helper"), f = function(a) {
            ...
            c.checked = !1) : (e = "12h", c.disabled = !1), this.callbackParams.Timer.setDateFormat({
                format: e
            }), f.dateFormat = e, f.abbreviations = c.checked), // If abbreviation checkbox is clicked
            a.target.disabled || "settings--ampm" !== a.target.id || (this.callbackParams.Timer.setDateFormat({
